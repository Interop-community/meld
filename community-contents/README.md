...
| `r4`                | `r4`                  | `745222113226.dkr.ecr.us-east-1.amazonaws.com/interop/api:develop` | `8070:8070`    | `SPRING_PROFILES_ACTIVE=r4,multitenant`<br>`API_PORT=8070`<br>`SANDBOX_NAME=hspc10`<br>`SBMA_HOST=localhost`<br>`SBMA_PORT=12000`<br>`DB_HOST=127.0.0.1`<br>`DB_PORT=3306`<br>`DB_USER=root`<br>`DB_PASSWORD=password`<br>`AUTH_HOST=localhost`<br>`AUTH_PORT=8060`<br>`MANIFEST_OVERRIDE=false` |         |                                      | `r4`     | `mysql: service_healthy`      |                               |                                                                                                |
...
Disclaimer:
Part of this document is generated by chatgpt 4.0.